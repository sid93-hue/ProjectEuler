...
def number_letters(n):
    ...
    # Add 7 for "hundred"
    if n == 100:
        return number_letters(1) + 7
    if n == 200:
        return number_letters(2) + 7
    if n == 300:
        return number_letters(3) + 7
    if n == 400:
        return number_letters(4) + 7
    if n == 500:
        return number_letters(5) + 7
    if n == 600:
        return number_letters(6) + 7
    if n == 700:
        return number_letters(7) + 7
    if n == 800:
        return number_letters(8) + 7
    if n == 900:
        return number_letters(9) + 7
    if n == 1000:
        return number_letters(1) + 8
    ...
    if n < 1000:
        ...
        if remainder < 20:
            ...
            units_digit = n % 10
            return (
                number_letters(hundreds_digit * 100)
                + 3
                + number_letters(tens_digit * 10)
                + number_letters(units_digit)
            )
